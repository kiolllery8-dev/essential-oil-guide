...
LIFEPATH = {
    ...
    6: dict(
        ...
        desc='你天生就想「修補東西、解決問題」，對別人的痛苦感同身受，常常一頭栽進別人的問題裡。'
             '你勇於扛責任，即使超出能力範圍也在所不辭，因為你天生樂於付出、責任感強。'
    ...
    8: dict(
        ...
        desc='你一眼就能看出哪些人事物有潛力，常常不為什麼就主動幫別人發展。你具備 1 的領導特質，'
             '會驅使自己追求金錢與獨立，而且目標往往遠超實際需求。你個性剛強，'
...
# ── 人際合盤（主命數相處建議）─────────────────────────────
# 「最有緣」依《幸福密碼》緣分指數的相差分數推導（相差6=互相依戀95、相差0=靈魂伴侶85、
# 相差1=夢中情人80、相差4=細水長流70），與下方互動緣分合盤一致，不再自創矛盾組合。
COMPAT = {
    1: '依緣分指數，和你最有緣的是 7（互相依戀）、2（夢中情人）、以及同為 1 號的人（靈魂伴侶）。相處上你愛得直接、要求高，記得多給對方一點空間。',
    2: '和你最有緣的是 8（互相依戀）、1 或 3（夢中情人）、同為 2 號的人。你溫柔願配合，但也別忘了把自己的需要說出來。',
    3: '和你最有緣的是 9（互相依戀）、2 或 4（夢中情人）、同為 3 號的人。你熱情浪漫，但要學著陪關係走長線。',
    4: '和你最有緣的是同為 4 號（靈魂伴侶）、3 或 5（夢中情人）、8（細水長流）。你重穩定，對變化多一點彈性會更輕鬆。',
    5: '和你最有緣的是同為 5 號（靈魂伴侶）、4 或 6（夢中情人）、1 或 9（細水長流）。你愛自由，要練習為關係定下來。',
    6: '和你最有緣的是同為 6 號（靈魂伴侶）、5 或 7（夢中情人）、2（細水長流）。你照顧得多，記得也讓對方疼你。',
    7: '和你最有緣的是 1（互相依戀）、同為 7 號（靈魂伴侶）、6 或 8（夢中情人）。你慢熱理性，練習走出頭腦，讓對方靠近你。',
    8: '和你最有緣的是 2（互相依戀）、同為 8 號（靈魂伴侶）、7 或 9（夢中情人）。你企圖心強，別讓掌控壓過了關係的溫度。',
    9: '和你最有緣的是 3（互相依戀）、同為 9 號（靈魂伴侶）、8（夢中情人）。你為愛奉獻，記得把愛也留一些給自己。',
    11: '11 號（緣分以縮減的 2 計）和 8、1、3 較有緣；你敏感投入，需要一個能給你安全感、又尊重你獨處充電的人。',
    22: '22 號（緣分以縮減的 4 計）和 4、3、5、8 較有緣；你忙於使命，記得把溫柔也留給陪你的人。',
    33: '33 號（緣分以縮減的 6 計）和 6、5、7、2 較有緣；你願意付出，別忘了找一個也會疼你的伴。',
}
...
# ⚠ 第三、第四階的 10／11／22 不化約：走到後半段的人已經過前兩階的淬鍊，
#    不會再回到「從零開始學」的狀態，所以這些數字保留原形（見 pinnacleOf()）。
# 欄位：name 短名／core 一句話定調／detail 這個階段會發生什麼（完整）／
#       watch 要小心什麼／deeper 更深一層的機制／modern 現代職涯與生活對應／do 可以做的事
PINNACLE_THEME = {
    1: dict(
        name='開創與獨立',
        core='學習並達成獨立、主動出擊，展現非凡的勇氣和屢敗屢戰的精神。',
        detail='這時候你必須獨立自主、主動出擊，展現出非凡的勇氣和屢敗屢戰的精神。'
               '即使經歷多次困難還是會重新站起來，學習獲得意志力，靠自己的力量前進，'
               '而不要陷入自憐的情緒或輕易投降。遇到困難時能屈能伸、夠柔軟，並持續朝自己的目標走。'
               '這個高峰循環是讓自己快速進步、成長的時期，你會被迫用上所有的天賦與才能，'
               '擁有強大的個人感、信念與力量，以及能組織眾人或機構的領導力。'
               '你有清楚的願景與信心，也了解自己的目標、夢想與價值，有機會做出重大成就。',
        watch='小心不要太自我中心、剛愎自用或太愛面子。有力量的同時也要有柔軟的彈性，'
              '打開心胸去接納不同的意見。',
        deeper='高峰數 1 只會在第一或第二階出現（有時兩階都是）。在第三或第四階，它會變成 10。'
               '1 是一個非常實際的數字，代表一段個人努力的時期即將到來，'
               '這是明確的自我表達期。對大多數人而言，這意味著與先前的某些關係分離開來——'
               '因為其中有某種程度的不和諧正在阻礙個人發展，可能發生在婚姻、商業結盟或社交圈裡。'
               '你可以放心：除非那段婚姻、業務關係或友誼已經達成它的目的，否則關係是不會中斷的。'
               '有些人會選擇盡力避免分離、寧願維持現狀，即使如此，你也無疑會察覺到'
               '那段關係的性質已經改變，因為雙方都開始發揮更多自己的個體性、變得更具表現力。'
               '你在靈性上愈進化（換句話說，靈魂愈老），這一年與往後的你就會發揮出更大的個體性。'
               '你行動的方向通常會與主命數一致，而你表達自我的方式，'
               '取決於你的生命靈數藍圖所顯示的個性優勢。',
        modern='現代對應：這是最適合開始「以自己為名」的九年——創業、獨立接案、'
               '從零經營個人品牌或自媒體、從組織內部拉出一條自己主導的產品線。'
               '如果你在公司裡，這段時間你會被推去帶新專案、開新市場、'
               '或成為那個「沒有前例可循時第一個跳下去做」的人。'
               '典型場景：離職創業、接下一個沒人做過的職位、把副業轉正、'
               '從團隊成員變成 leader。相對不適合的是需要長期配合他人節奏、'
               '沒有決策權的位置——那會讓這個階段的能量卡住。',
        do='把「我想要什麼」明確講出來，並實際啟動一件屬於自己的事；'
           '每次跌倒後記下你是怎麼站起來的——那個紀錄就是這個階段真正累積的資產。'),
    2: dict(
        name='協調與感受',
        core='學習並達成合作、團隊、溝通，用溫和的方式說服他人並達成目標。',
        detail='這時候你會特別感性，直覺力與洞察力都很強，必須學習如何透過溫和的方式，'
               '有力量地說服他人並達成目標。你適合、也有天賦扮演在一旁輔佐的角色——'
               '顧問、調停者、外交家這一類——因為你能看透人與人之間的感覺、動機或關係。'
               '這個高峰循環需要你培養並付出耐心、提升覺察力，'
               '挑戰是如何把二元對立的價值放到平衡：在爭辯的正反方之間取得中間的和平共處地帶，'
               '成為眾人的協調劑。',
        watch='此階段要克服的是過於敏感的問題，甚至會想躲避任何負面的人事物。'
              '試著發揮善解人意與洞察力的特質，讓自己更有魅力，朝正向特質發展。',
        deeper='高峰數 2 引入的是一段「更強烈的靈性價值浮現」的時期。'
               '生活方式和習慣會巧妙地轉向一種更直覺、更富情感的方式。'
               '這種靈性強調究竟會表現為改善後的覺知狀態（積極、具建設性的形式），'
               '還是表現為情緒高漲的狀態（反應性而失敗的形式），取決於你迄今達到的成熟度——'
               '顯然，一個人若被情感所束縛，就無法期待他發展出直覺的能力。'
               '這通常是物質事務進展緩慢、工作艱苦的時期，但我們不能兩全其美。'
               '請記住：一切事物都有它合適的時機，而生命靈數最重要的應用之一，'
               '就是學習了解我們的需求為何，以及處理它們的正確方式與正確時間。'
               '在高峰數 2 的影響下強行追求物質進展，只會引起挫敗感、衝突和情感上的無力。',
        modern='現代對應：專案協調、人資、客戶成功、UX 研究、諮商與心理輔導、'
               '社群經營、公關、行政統籌——所有需要「讀懂人」的位置。'
               '在自媒體領域，這個階段適合做訪談型內容、共創與聯名，而不是單打獨鬥的個人秀。'
               '典型場景：從執行者變成協調角色、加入一個需要多方溝通的專案、'
               '成為團隊裡那個「大家都願意跟他講真話」的人。'
               '這段時間業績數字類的目標會走得特別慢，不要拿它當唯一的自我評價。',
        do='練習在對立的兩造之間找出中間地帶；把每次「感覺到什麼」寫下來，'
           '過一陣子回頭對照結果，讓直覺變成可以信任的判斷工具。'),
    3: dict(
        name='表達與創造',
        core='學習並達成創意的表達、歡樂與分享，創造獨特魅力或個人特色。',
        detail='這時候你的自我表達能力會大幅提升，會被創意與藝術天分吸引——'
               '寫作、繪畫、音樂、戲劇、舞蹈這類領域都會走到高峰，'
               '所以你可以從事擅長的藝術活動或其他相關領域，好好發揮才能。'
               '這個高峰循環充滿許多社交活動，也是感性的時期，'
               '擁有獨特魅力或個人特色能吸引更多朋友與仰慕者，你會有鼓舞他人的能力。',
        watch='此階段要小心的是避免太過放縱而缺乏生產力，做事也不要只是一時興起或太衝動。'
              '要學會專注、持續與自律，才不會太過任性。',
        deeper='高峰數 3 始終是強調智力追求的時期，是學習、複習和分析的重要階段。'
               '在這種能量的引導下，許多人會發現想要旅行的渴望特別明顯——'
               '在你生命的這個階段，旅行扮演非常重要的角色，'
               '它是學習、也是擴大你對生活洞見的一種手段。'
               '如果你不讓自己的心智能力進行積極的擴展，'
               '就有風險變成一個帶有破壞性批判、要求嚴厲、不足為奇而頗不受歡迎的人。',
        modern='現代對應：內容創作者、YouTuber、Podcast 主持、短影音、'
               '設計、文案、行銷企劃、講師、活動主持。'
               '這是自媒體與個人 IP 最容易起飛的九年——你的辨識度會自然變高。'
               '典型場景：開一個頻道並持續更新、出書或開課、'
               '從幕後走到台前、把興趣變成有人追蹤的作品。'
               '要注意的是這領域最容易「開很多坑不填」，'
               '這個階段的成敗差別就在有沒有把作品做完並發表出去。',
        do='選一種創作形式，設定一個做得完的作品，把它完成並公開；'
           '安排一次以學習為目的的旅行，回來後把看到的東西轉成作品。'),
    4: dict(
        name='築基與耐性',
        core='學習並達成藉由勤勞不懈的工作去奠定基礎，保持耐性與組織力。',
        detail='這時候你處於辛勤工作、也獲得報酬的階段，會因為努力而打下持久的基礎。'
               '若擔任管理者、組織者或其他體制的基石角色，能力將大幅增強，'
               '因為你具備值得依賴、可靠、負責任、勤奮、務實地一步一步往前的特質。'
               '這個高峰循環你也會以務實的方式生活或關心他人，'
               '同時生活充滿許多需要你注意的細節與責任，你對效率、秩序等會有所要求。',
        watch='此階段要小心不要把精力全部耗盡在細節上，避免撐到極限而垮掉。'
              '同時要了解：持久的事物是要有條有理地達成的，不要心急，也要適當地放鬆與保有彈性。',
        deeper='高峰數 4 為你帶來更大的物質強度。這會以多種方式呈現，'
               '取決於整體成熟度、主命數與命盤的特徵。'
               '對於那些準備好努力工作的人來說，在這種能量振動下可以取得很大的成就。'
               '對於那些需要獲得更多知識、以應對各種感官功能來完善其成熟度的人，'
               '以及那些準備讓自己參與體力勞動的人來說，'
               '至關重要的發展會為他們的努力帶來獎勵。'
               '但是那些變得野心過大、唯利是圖或貪婪的人，'
               '會發現這段時期帶來的是損失而不是收益——'
               '儘管你可能會更加努力，但因為動機如此自我中心，你不會取得明顯的進展。'
               '這可能導致嚴重的神經緊張並影響整體健康狀況，'
               '只有在你重新評估自己的動機之後，才能夠加以糾正。',
        modern='現代對應：工程師、資料工程、會計與財務、物流與供應鏈、'
               '專案管理、品管、營運、法遵、系統建置。'
               '這個階段適合把「一次性的努力」變成「會自己運轉的系統」——'
               '寫下 SOP、建流程、做自動化、把手工作業變成可複製的機制。'
               '典型場景：接下營運或管理職、把一個混亂的部門整理起來、'
               '取得專業證照、把接案模式升級成公司。'
               '對電商與自媒體來說，這是建後台、理庫存、把數據看清楚的階段，'
               '不是衝爆發性流量的階段。',
        do='把大目標拆成可執行的系統與時程；每週保留固定的放鬆時段，'
           '不是有空才休息——這個階段的健康風險是真的。'),
    5: dict(
        name='自由與經驗',
        core='學習並達成開放與自由，認識廣大世界並獲得經驗。',
        detail='這時候你對自由、到遙遠的地方旅行、冒險等會有所嚮往或實踐，'
               '處於實驗、學習、認識廣大世界與獲得經驗的時期。'
               '同時語文、文字、寫作溝通等表達能力可能大幅提升，讓你能成功推銷自己，'
               '進而擁有新工作、新冒險、新環境、新挑戰、新體驗或新機會。'
               '這個高峰循環的自由、挑戰、變化等能量會大增，'
               '會讓你接觸並學習更廣泛的領域或人事物。',
        watch='要避免讓自己太過自由、完全無拘無束或變化無常。'
              '在某個領域、職業或一段關係當中，還是要保有一定穩定的發展。'
              '即使害怕被綁住，但那其實並不會限制你的自由，而是讓你保有立足點。',
        deeper='高峰數 5 通常會使你的情緒狀態發生重大變化。'
               '這些變化是透過靈性成長與理解的出現而產生的，'
               '而靈性成長與理解又會帶來更大的個人自由。'
               '在這段時期內，超自然的感受力得到極大增強，'
               '從而促進了情緒控制水平的提高；'
               '反過來，這減少了你對他人狀況的反應性行為。'
               '結果是個人自由得到更大的發展，'
               '而這正為提高你的靈性覺知打好基礎。'
               '若你屬於那些早年擔心自己財務安全的人，'
               '現在可以透過更平衡地了解自己的實際需求與環境影響，來消除這種擔憂。',
        modern='現代對應：業務與 BD、跨境電商、旅遊與觀光、外派與遠距工作、'
               '多角化接案、社群與短影音操作、需要大量出差或見人的角色。'
               '這個階段適合同時經營好幾條線，並從中找出真正要走的那一條。'
               '典型場景：換到完全不同的產業、開始接海外案子、'
               '成為數位遊牧、把工作模式改成遠距、一年內換了三種嘗試。'
               '注意這階段最容易「什麼都試、什麼都沒留下」，'
               '刻意留一件事持續做滿全程，會讓這個階段的收穫完全不同。',
        do='安排一次真正離開日常的旅行或工作型態轉換；'
           '同時刻意選一件事維持不變，當作你的錨。'),
    6: dict(
        name='愛與責任',
        core='學習並達成關愛、家庭及心靈方面的家居或生活。',
        detail='這時候你可能會因為身上的責任與義務增加，'
               '而花許多時間與家人、朋友或社群的人相處，'
               '並在看清事情之後讓生活回到平衡，也妥善處理情感議題。'
               '同時人們會需要你的諒解、包容與寬恕，所以你必須照顧許多人。'
               '這個高峰循環你會感受到充滿愛、親密感與溫暖，'
               '即使感到勞累也會覺得是甜蜜的負擔，'
               '會因為照顧與幫助他人而感到滿足與存在感。',
        watch='此階段要小心太過付出，而沒想到自己的立場、或自己是否有能力付出。'
              '必須學會維持自己的尊嚴，不要自我犧牲過了頭，'
              '要知道自己的界線在哪裡，才能持續真心地幫助他人。',
        deeper='高峰數 6 具有極大的力量可以進行創造性的發展。'
               '在這個時期，最高的靈性與心智能力可以結合起來，'
               '向我們展示自己在無限的創造計畫中所扮演的重要角色。'
               '這種崇高的覺知，幾乎只會被那些更成熟、進化程度更高的人所理解。'
               '所以對大多數人來說——那些認同於身體／物質上的佔有慾的人——'
               '這會成為一段強烈參與家庭的時期；'
               '或者如果你還沒有結婚，那就會渴望在自己的家中安頓下來。'
               '那些擔心家庭、或倉促結婚的傾向，'
               '應該被視為「原本可以很強大的創造性驅力」被錯放的對應物。'
               '你應該運用智慧與耐心，'
               '以避免在情緒主導人們事物時所吸引來的有害教訓。',
        modern='現代對應：教師與教育工作者、護理與長照、心理與身心靈輔導、'
               '芳療與療癒工作、社福、社群經營、客戶關係、家族企業。'
               '這個階段也是「把照顧變成專業」的好時機——'
               '很多人在這階段考證照、開工作室、把陪伴他人變成職業。'
               '典型場景：結婚生子、承接家中責任、'
               '從自由工作轉成需要對一群人負責的角色、開始帶學生或個案。'
               '對創作者而言，這階段的內容會自然轉向溫暖、療癒、關係主題。',
        do='每次答應之前先問「這是誰的功課」；'
           '替自己保留一段完全不被打擾的時間，並且寫進行事曆。'),
    7: dict(
        name='內省與智慧',
        core='學習並達成智慧、獨處及內在的平和，取得靈性成長與增加知識的機會。',
        detail='這時候你處於一個靈魂探索與心靈成長的時期，'
               '可能會面臨個人存在、人生意義等深層的內心問題。'
               '同時你也會試著欣賞大自然、或歌頌那些能陶冶心靈的作品，'
               '這會帶來靈性上的滋養與成長，'
               '接著你會有熱衷而專精的精力，去追尋某種發展或某個領域的探求。'
               '這個高峰循環你的分析能力會更強、直覺力會更敏銳，'
               '能夠有強大的、穿透事物本質的洞察力，'
               '充滿靈性成長、增加知識與智慧的機會。',
        watch='此階段要小心的是避免太過分析而吹毛求疵，'
              '或太過理想化、看輕他人而憤世嫉俗。'
              '要了解人在大多數時候是不完美的，不必太過苛求；'
              '要能獲得洞察力和智慧，才能達到真正的提升。',
        deeper='高峰數 7 會給人們的生活帶來許多令人驚訝的變化。'
               '在這個時期，我們被要求分享到目前為止所學到的一切；'
               '這樣一來，我們自身的發展會經歷巨大的進步，'
               '因為沒有任何比教學更好的學習系統了。'
               '這是生命中一段強烈的經驗主義時期，因為它要求我們進行很多測試——'
               '如果成功，我們就有資格獲得在前方等待著我們的更高教義；'
               '如果我們還沒有成熟到一個可接受的成長點，'
               '就必須花更多的時間在準備性的發展上。'
               '在這個能量振動的影響時期，大多數人都被要求進行某種形式的教學，'
               '但不一定是在傳統的學術領域——'
               '他們的教學更多與人類進化的「後學術領域」相關，'
               '例如瑜伽、自然療法、靈性覺知和藝術發展。',
        modern='現代對應：研究與開發、資料分析、AI 訓練師與提示詞設計、'
               '資訊安全、學術與寫作、深度型 Podcast、'
               '以及療癒領域——瑜伽老師、冥想引導、芳療個案、塔羅與占星諮詢。'
               '這個階段最典型的轉折是「從做的人變成教的人」：'
               '開課、寫教材、帶讀書會、把自己的專業整理成一套可傳授的東西。'
               '典型場景：進修或攻讀學位、離開熱鬧的環境去做研究、'
               '開始獨立接個案、把多年經驗寫成書或線上課程。'
               '相對不適合在這個階段硬推需要高頻社交應酬的業務型工作。',
        do='找一個題目深入研究，然後試著講給別人聽——'
           '教學會讓你學得最快；安排規律且不被打擾的獨處時間。'),
    8: dict(
        name='成就與豐盛',
        core='學習並達成財富、成功與成就感，擁有足夠的智慧、判斷與洞察。',
        detail='這時候你處理商業、財務、事業或職業等的能力會增強，'
               '是物質、回報或財富有所提升與收割的時期。'
               '同時你能夠加強個人能力，'
               '並擁有足夠的智慧、判斷力、洞察力與目標，能向前邁進並使之成功，'
               '讓人感到你有力量、有效率，顯得十分能幹。'
               '這個高峰循環你將更有能力組織團隊、創立事業等較高難度的人生里程碑，'
               '即使遇到麻煩也會視為挑戰而非威脅，'
               '進而感受到個人能力增強且越來越穩定，'
               '會以目標導向、帶著清楚的頭腦前進。',
        watch='此階段要小心不要忘記人性與心靈層面的重要程度。'
              '即使遇到極大的誘惑——例如把金錢、權勢或各種慾望看得太重——'
              '也要懂得做出正確的抉擇，不要被蒙蔽了雙眼，'
              '才會有良好的平衡與成長的機會。',
        deeper='高峰數 8 意謂著在這個非常強大的時期，獨立性是主導的力量。'
               '至於這種獨立性是透過藝術還是商業參與而發展，將取決於主命數：'
               '如果主命數是偶數（2、4、6、8），通常表示財務上的成功；'
               '如果是奇數（1、3、5、7、9），則更有可能透過藝術'
               '（或對某些人是學術）的表達而獲得成功。'
               '必須謹慎而有建設性地運用這種能量振動的力量，'
               '並且不要讓對立的個人、或限制性的情況抑制它的傳播。'
               '這種影響若受阻，結果會清楚地表現為一種非典型的漠然——'
               '那其實是靈魂為了實現獨立表達而掙扎著做出的努力。',
        modern='現代對應：創業與經營、投資與財務規劃、營運長與事業處主管、'
               '電商規模化、品牌授權、併購與募資、'
               '以及把個人品牌轉成商業體的所有動作。'
               '這個階段適合談錢、談合作、談規模——'
               '把原本靠自己做的事，變成靠團隊與系統做的事。'
               '典型場景：公司從一人變成一群人、拿到關鍵訂單或投資、'
               '把年營收推上新的量級、開始有人替你執行。'
               '奇數主命數的人不要硬套「一定要賺大錢」，'
               '你的豐盛更可能來自作品或專業本身被看見。',
        do='設定一個可量化的目標並拆成年度里程碑；'
           '同時固定做一件不賺錢、但你真的重視的事，當作校準用的尺。'),
    9: dict(
        name='付出與圓滿',
        core='學習並達成愛與同理心，想要讓社會更加美好。',
        detail='這時候你是個高度的理想主義者，'
               '最大的滿足感來自於幫助他人以成就自己，'
               '所以你會參加超過個人利益的大型目標或計畫等活動，'
               '並感到自己的力量特別強大，'
               '因為你知道自己正在為社會眾人謀求福利，做善事、服務大眾。'
               '這個高峰循環你會感受到更加強烈的責任感與同情心，'
               '幫助更多相對弱勢的人，'
               '可能會投身於某個社會理念或參加某些慈善活動，'
               '並想要讓社會更加地美好。',
        watch='此階段必須小心提醒自己要努力取得平衡，衡量自身的能力。'
              '自我犧牲必須要有個限度，不是要當個殉道者，'
              '才能夠在顧及自身的情況之下，讓周遭環境變得更加美好。',
        deeper='高峰數 9 會引入一段明顯的人道主義活動時期，'
               '這種能量振動帶來了為人類服務的特殊機會。'
               '在這段時間裡，需要大量的心智投入才能取得最大的成功：'
               '分析和評估他人的需求、計畫職業的重大變化，'
               '並重新評估長期的關係與周遭環境。'
               '此期間會有許多人來要求你付出時間和精力——'
               '有些人是真的需要，並提供了重要的服務機會；'
               '有些人則是矯揉造作地引起你的同情，'
               '後者應被視為是需要被喚醒的人。'
               '我們的分辨與分析能力，必將透過這種經驗得到檢驗和加強。'
               '有些人在這種能量振動下需要留在家裡待命服務，'
               '而其他人則需要出差旅行，接受重要的發展課程。'
               '在這高峰數到達後的第一年影響下，'
               '每個人都會發現自己生活中發生了重要變化——'
               '如果不涉及旅行，他們幾乎毫無例外地會搬家、換工作或結識新朋友。'
               '這些生活方式的改變中的任何一種都可能發生，'
               '取決於朝著成熟成長的主要階段所必須負擔的責任之性質。',
        modern='現代對應：非營利組織、社會企業、公益倡議、教育推廣、'
               'ESG 與永續、公共政策、志工組織、'
               '以及把專業無償或低價開放給更多人的所有做法。'
               '對創作者來說，這個階段的內容會自然轉向「利他」——'
               '教學型、科普型、替某個族群發聲的題材會特別有共鳴。'
               '典型場景：投入一個社會議題、把技能拿去做公益、'
               '搬家或轉職到與價值觀更一致的地方、'
               '結束一段長期關係或工作並展開新的。'
               '進入這階段第一年務必留意：變動幾乎一定會發生，先做好準備。',
        do='選一個你真的在乎的議題長期投入；'
           '同時明確寫下你能付出的時間與金錢上限，並且守住它。'),
    10: dict(
        name='引導與成全',
        core='理解他人需求來創造快樂結果，引導和鼓勵他人是令人興奮且雙贏的局面。',
        detail='高峰數 10 只會隨著成熟度接近頂點，出現在第三或第四個高峰上。'
               '它會在重要的人生調整期間帶來特殊的力量——'
               '一種能理解他人需求的獨特力量。'
               '這種能力來自於「人們自己的生活經驗、以及那些經驗所帶來的培訓」'
               '所結出的快樂結果。'
               '正如上個世紀每個出生日期中的 9 表示對思維能力的著重，'
               '隨著新時代的到來，我們需要大量的思維調整來改造觀念和生活方式。'
               '在此期間擁有高峰數 10 的較老靈魂，'
               '在引導和鼓勵有需要的人這方面，扮演至關重要的角色。'
               '這是一個令人興奮的責任，它賦予給予者與接受者一樣多的利益。',
        watch='別把自己走過的路當成唯一正解。你的經驗是參考，不是模板；'
              '對方的節奏、資源與時代條件都不會跟你一樣。'
              '引導的價值在於讓對方找到自己的答案，不是複製你的答案。',
        deeper='10 在第三、第四階不會化約成 1——這是關鍵。'
               '因為你已經走過前面兩個階段的淬鍊與學習，'
               '不可能再回到第一、第二階那種「從零開始學」的狀態。'
               '1 是純粹的開創，帶著莽撞與試錯；'
               '10 則是走過一輪之後的開創，多了那個 0 所代表的完整與圓熟。'
               '同樣是帶頭的角色，前者是自己往前衝，後者是回頭把人帶上來。',
        modern='現代對應：業師與顧問、教練（商業／生涯／健身）、'
               '資深主管的傳承角色、產業導師、社群的意見領袖、'
               '把多年經驗做成課程或方法論的人。'
               '這個階段最有價值的產出不是你又做成了什麼，'
               '而是有多少人因為你的引導而走得更順。'
               '典型場景：擔任新創的顧問或投資人、'
               '在公司裡負責培養接班梯隊、開始帶學徒或實習生、'
               '把自己的方法論寫成書或建立學派。'
               '對自媒體來說，這階段適合從「分享我在做什麼」'
               '轉成「我來幫你把你的事做好」。',
        do='挑一兩個人認真陪伴，而不是對很多人廣泛地給建議——'
           '這個階段的價值在深度不在數量；'
           '把你的經驗整理成別人可以拿去用的方法，而不只是故事。'),
    11: dict(
        name='靈性責任',
        core='學習並達成合作、團隊、溝通，說服他人並達成目標——但帶著更高的靈性責任。',
        detail='這時候你處於充滿挑戰、高度敏感與直覺的時期，'
               '會受到資訊與洞察力的鼓舞或衝擊，充滿強度的啟示會湧入心頭，'
               '所以你必須學會透過一些信念來讓自己的人生站穩腳步，'
               '讓靈性與個人大幅成長，並用獨特或與他人不同的見解看清人生。'
               '這個高峰循環的影響使你擁有創意、創新等能力，'
               '處理問題的方式可能與傳統不同，'
               '但要相信自己的直覺，並找到平衡點以恢復內心的平靜。',
        watch='此階段必須小心內心世界可能會發生許多事而導致混亂，'
              '或不知道何去何從。高度緊繃的時期可能會導致壓力過大，'
              '此時要從中找到平衡點，並在帶給他人快樂的同時感到自我滿足。',
        deeper='高峰數 11 是可在第三或第四個高峰上出現的兩個峰值中的第二個。'
               '與高峰數 10 一樣，必須有高度的成熟度才能發揮它的力量。'
               '高峰數 11 表明需要大量的靈性責任感，'
               '但是這個需求永遠不會超出個人的能力。'
               '這是一個高度直覺的時期，此時最受啟發的行動變得可能。'
               '但是要實現這一時期的最佳潛力，還存在某些靈性上的需求，'
               '這些包括慈悲心、節制、正直和冥想練習。'
               '慈悲心的意義遠不只是「關懷同情和舒適」這種有限的現代解釋——'
               '它是一種慈悲的行為，在最高的靈性意義上分享愛；'
               '用非常實際的話來說，它意謂著對所有生命、特別是人類生命，'
               '表現出體貼並維持和諧。'
               '節制是在所有事物中的平衡與適量的表達，'
               '而冥想則是透過放鬆身心來恢復全然和諧的一種開悟運動。'
               '無可挑剔的正直，必須在所有行動和思想中占主導地位，'
               '從而確保沒有負面力量可以阻礙靈性的綻放——'
               '這是這一時期至上的目標。',
        modern='現代對應：身心靈教學與療癒工作、直覺型創作、'
               '心理與精神健康領域、生命教育、靈性社群的帶領者，'
               '以及所有需要「先感覺到、才說得出來」的工作。'
               '在一般職場裡，這個階段你常會是那個「先察覺到問題」的人——'
               '組織文化、團隊氣氛、產品方向出錯時，你比別人早知道。'
               '典型場景：開始教別人靜心或療癒、'
               '把靈性經驗整理成可以傳遞的內容、'
               '在高壓環境裡成為穩定人心的角色。'
               '要特別留意身心負荷：高敏感的人在這個階段最容易耗竭，'
               '規律作息與界線不是選項，是必要條件。',
        do='建立每天固定的靜心或放鬆練習；'
           '把湧現的直覺寫下來，隔一段時間回頭檢驗準確度，'
           '讓它從「感覺」變成你可以信任並拿出來用的能力。'),
    22: dict(
        name='大願景',
        core='學習全心全意投入，不畏艱難地實踐長期目標，獲得巨大成就。',
        detail='這時候你處於吃力的時期，'
               '但會設法駕馭個人力量並面對巨大的挑戰（包含實體與心靈層面的），'
               '並努力用上強大的能力去實踐某項大計畫、事業或夢想，'
               '甚至謀求社會整體的幸福，建立宏大且持久的事物。'
               '這個高峰循環會讓心靈的力量、決心與效率等能力大幅增強，'
               '你專注的事物與計畫，規模大多屬於較龐大的，'
               '同時也需要擁有較長的時間來實踐，'
               '以帶來深遠又持久的影響。',
        watch='此階段所遇到的問題與挑戰也較大，必須要全心全意地投入才能夠實現，'
              '否則容易因失敗而進入沮喪的狀態。'
              '但這是一個充滿潛力的時期，付出努力、盡情揮灑之後能夠獲得極大的成就。',
        deeper='22 是大師數，同樣需要足夠的成熟度才承接得住，'
               '所以它出現在人生後段而非開頭。'
               '它與 4 的差別在規模與時間尺度：'
               '4 是把眼前的事做穩，22 是把一個會影響很多人的結構蓋起來。'
               '這也意味著你在這個階段裡看不到即時回報是正常的——'
               '這個數字的成果通常在階段結束後才完全顯現。',
        modern='現代對應：建立大型系統或平台、社會企業、'
               '產業標準或基礎建設、跨國或跨領域的整合專案、'
               '教育機構或長期組織的創辦、影響一整個族群的產品。'
               '典型場景：投入一個十年尺度的計畫、'
               '把個人事業轉成能留下來的組織、'
               '推動一件需要說服很多人才能成立的事。'
               '這個階段最忌諱的是同時開好幾個大案——'
               '22 的能量只夠支撐一件真正的大事。',
        do='選定一個十年尺度的目標，然後只做能推進它的事；'
           '把它切成每年看得見的進度，避免因為看不到終點而放棄。'),
}
...
COMBO = {
    ...
    16: '修煉數——有衝勁，但要先付出才會有 1 號的幸運；不付出就少了那份運。',
...
# ── 打破框架（限制數＝生月數＋生日數，不化約）──────────────────
# 範圍 2-18。(框架描述, 打破的具體做法)。原創改寫。
# 定調：這是「可以拆掉的牆」，不是宿命，所以每一條都給得出可以今天就做的動作。
LIMIT = {
    2: ('從小被期待「乖、聽話、不要吵」，你很早學會察言觀色，把別人的臉色放在自己的需要前面。',
        '這週挑一件小事，在還沒確認對方反應之前就先說出你想要什麼。不必爭贏，說出口本身就是練習。'),
    3: ('成長環境重視表現與反應快，你習慣用幽默和熱鬧掩飾不安，安靜下來反而心慌。',
        '找一個安全的人，在他面前允許自己講一次不精采的話、冷場一次。你會發現關係沒有因此變薄。'),
    4: ('家裡強調規矩與安全，你把「穩定」內化成唯一選項，任何變動都先被當成風險。',
        '刻意做一件小規模的、可以失敗的嘗試（換一條通勤路線也算）。讓身體體驗到：改變不等於失控。'),
    5: ('成長過程變動多、或管束忽鬆忽緊，你學會隨時準備離開，關係與工作都不敢太投入。',
        '選一件事承諾做滿一輪（三個月的課、一份專案）。中途想跑的時候記下來，但先做完再決定。'),
    6: ('你很早被賦予照顧者的角色，習慣把別人放前面，甚至覺得不付出就沒有位置。',
        '這個月拒絕一次你其實不想接的請託，不解釋原因。位置不會因此消失——這就是要驗證的事。'),
    7: ('環境裡少有人真的懂你，你把自己收進腦袋裡，用分析代替求助。',
        '把一件還沒想清楚的事，在還沒想清楚的狀態下講給一個人聽。不求建議，只求被聽見。'),
    8: ('家中對成就或金錢的態度很鮮明（極度重視或極度匱乏），成了你衡量自己的內建尺。',
        '寫下三件你做得很好、但完全不賺錢也不會被稱讚的事。每天看一次，把尺換掉。'),
    9: ('你從小懂事、替大局著想，情緒常常還沒出口就被自己壓下去。',
        '練習說「我不想」——不加理由、不加抱歉。一週一次就好，從最安全的人開始。'),
    10: ('被期待要獨當一面，你不太會示弱，連累的時候都要撐著。',
         '這週開口請人幫一個你自己也做得到的忙。重點不是省力，是讓身體習慣「被幫」。'),
    11: ('你對氛圍極度敏感，很早學會替空氣裡的緊張負責，別人心情不好你會先檢討自己。',
         '下次感覺到低氣壓時，先在心裡說一句「這不是我造成的」，然後什麼都不做，觀察十分鐘。'),
    12: ('你習慣用活潑與配合換取和諧，覺得掃興會讓關係出問題。',
         '在一次聚會裡誠實說一次「我今天沒力氣」。真的在意你的人不會因此走開。'),
    13: ('你被要求「先把該做的做完」，玩樂總帶著罪惡感，休息時腦袋還在跑。',
         '排一段沒有生產力的時間，並且不補做任何事。把休息當成行程，不是剩下的時間。'),
    14: ('成長中規則常變，你學會快速適應但難以深根，換得快也放得快。',
         '選一件已經做了一陣子的事，再多做三個月不換。深度是靠重複長出來的，不是靠選對。'),
    15: ('你在自由與責任之間被拉扯著長大，選了任何一邊都覺得虧欠另一邊。',
         '寫下這半年最想要的兩件事，強迫自己排先後。不是放棄一個，是決定先做哪個。'),
    16: ('你經歷過某種突然的崩解或落差，因此對「太順」有戒心，好事來了先想代價。',
         '這次好事發生時，練習只說「謝謝」，不追問為什麼、不預先防範。讓它單純地發生。'),
    17: ('你被期待要撐住、要成功、不能倒，久了連自己都忘記可以喊停。',
         '對一個信任的人說一次「我有點撐不住」。說完觀察：你原本以為會失去的，其實都還在。'),
    18: ('你很早看見大人的難處，把體諒變成本能，習慣先理解別人再處理自己。',
         '這次讓別人先照顧你一次，不要在中途接手。被照顧也是一種能力，需要練。'),
}
...
def build_data():
    ...
    limit = {k: dict(frame=v[0], breakit=v[1]) for k, v in LIMIT.items()}
...
EDU_SECTION = '''
  ...
  <section style="margin:44px 0;">
    ...
    <div class="num-card"><strong style="color:#7A5A8E;">Q：生命靈數是不是算命？</strong><p style="margin:8px 0 0;font-size:14.5px;line-height:1.85;">嚴格說不算。它比較像一份「性格大數據」，用西元生日換算出 1 到 9 的能量原型，幫你看懂個性與天賦、發揮自己。算命／東方命理（八字、紫微）則擅長看時機與運勢節奏。兩者切入點不同，目的都是了解自己。想看七大面向逐項對照 👉 <a href="/numerology-vs-fortune-telling/" style="color:#6F5E93;font-weight:600;border-bottom:1px solid #C9B6DF;text-decoration:none;">算命 vs 生命靈數完整對照表</a>。</p></div>
...
MAIN_BOTTOM = '''
  <section style="max-width:980px;margin:8px auto 0;padding:0 20px;">
    ...
    <div style="display:flex;flex-wrap:wrap;gap:10px;">
      ...
      <a href="/article-angel-numbers/" style="flex:1;min-width:240px;padding:14px 18px;background:var(--beige-light,#FBF7F1);border:1px solid var(--border,#E5D9C0);border-radius:12px;text-decoration:none;color:inherit;">
        <div style="font-weight:700;font-size:15px;color:var(--green-dark);margin-bottom:3px;">🔢 天使數字總覽</div>
        <div style="font-size:13px;color:#7A6A5A;line-height:1.6;">111～1212 速查表，與 1414、1133、4444 深度解讀</div>
      </a>
      <a href="/article-tarot-basics/" style="flex:1;min-width:240px;padding:14px 18px;background:var(--beige-light,#FBF7F1);border:1px solid var(--border,#E5D9C0);border-radius:12px;text-decoration:none;color:inherit;">
        <div style="font-weight:700;font-size:15px;color:var(--green-dark);margin-bottom:3px;">🎴 塔羅牌入門</div>
        <div style="font-size:13px;color:#7A6A5A;line-height:1.6;">78 張牌結構、22 張大牌速查與新手牌陣</div>
      </a>
    </div>
  </section>
...
(function(){
  ...
  byId('num-go').onclick=function(){
    ...
    // ── 四階高峰數 ─────────────────────────────────────────────
    // 規格：年、月、日各自化約成個位數後套公式（與 rm/rd/ry 同一組值）。
    //   第一高峰數＝生月數＋生日數　第二＝生日數＋生年數
    //   第三＝第一＋第二　　　　　　第四＝生月數＋生年數
    // 第三、四階遇 10／11／22 不化約——隨著人生第三階段臨近，
    // 走過前兩階淬鍊的人不會再回到「從零開始學」的狀態，
    // 這些數字更強大的靈性影響在此格外重要。
    function pinnacleOf(sum,stage){
      if(stage>=3&&(sum===10||sum===11||sum===22))return sum;
      return reduceNum(sum);
    }
    var p1=pinnacleOf(rm+rd,1),p2=pinnacleOf(rd+ry,2);
    var p3=pinnacleOf(p1+p2,3),p4=pinnacleOf(rm+ry,4);
    // 高峰期年齡分界：第一期 0 ~ (36 − 命運數)，之後每 9 年一段。
    // 命運數取值依快速查閱表：主修數 10/1 取 10、大師數 11 取 11、
    // 22/4 取 4（表中 22/4 與主命數 4 同為 0–32 歲）、其餘取主命數。
    // 主命數 1 的化約鏈必定經過 10（最小生日數字和已大於 9），故一律取 10。
    function destinyForAge(lifeNum){
      if(lifeNum===11)return 11;
      if(lifeNum===22)return 4;
      if(lifeNum===33)return 6;
      if(lifeNum===1)return 10;
      return lifeNum;
    }
    var e1=36-destinyForAge(life),age=ty-y-(passed?0:1);
    ...
    var extra={ch:[ch1,ch2,ch3,ch4],limit:limitNum,course:chain.slice(),
               fm:fMonth,fd:fDay,cm:cm,cd:cd,e1:e1,destiny:destinyForAge(life)};
    setNow(age);
  ...
  function render(life,bday,talent,zo,innate,counts,missing,active,flow,ty,combo,stages,curStage,age,lunarNote,flowInfo,zodiac,extra){
    ...
    h+='<div class="num-card"><h3 class="num-h2">⛰️ 人生四階段大運（高峰數）</h3>';
    h+='<p style="font-size:13.5px;color:#7A6852;margin:0 0 4px;">人生分成四個階段，每一段被一個數字能量主導——那個數字會決定你在那段時間被推去練什麼、什麼事變容易、什麼事會卡。第一階最長，從出生到 '+extra.e1+' 歲；第二、第三階各九年；第四階是 '+(extra.e1+19)+' 歲以後的餘生。你現在大約 '+age+' 歲，走在下方標示「你現在這裡」的那一段。</p>';
    h+='<p style="font-size:12.5px;color:#9A8AA8;margin:0 0 12px;">每一階都可以展開看完整說明。<b>第三、第四階若出現 10、11、22，不會化約成 1、2、4</b>——走過前兩階的人不會再回到從零學的狀態。</p>';
    var labels=['第一階段','第二階段','第三階段','第四階段'];
    stages.forEach(function(st,i){
      var on=i===curStage,pk=D.pinnacle[st.num]||null;
      var range=st.to===null?(st.from+' 歲以後'):(st.from+'–'+st.to+' 歲');
      var big=(st.num===10||st.num===11||st.num===22);
      ...
      h+='<div style="flex:1;"><div style="font-size:15px;font-weight:700;color:#3D3328;">'+(on?'<span style="color:#B5701A;">▸ 你現在這裡 · </span>':'')+(pk?pk.name:'')+(big?'<span style="font-size:11px;background:#EFE6F5;color:#7A5A8E;border-radius:5px;padding:2px 7px;margin-left:6px;">不化約</span>':'')+'</div>';
      ...
      if(pk){
        ...
        h+='<div style="font-size:14.5px;line-height:1.95;color:#3D3328;margin-bottom:12px;">'+pk.detail+'</div>';
        h+='<div style="background:#FFF4E6;border-left:4px solid #E8A04B;border-radius:8px;padding:11px 14px;font-size:14px;line-height:1.9;color:#3D3328;margin-bottom:12px;"><b style="color:#B5701A;">⚠ 要注意提醒：</b>'+pk.watch+'</div>';
        h+='<div style="background:#F4EFF8;border-radius:8px;padding:11px 14px;font-size:14px;line-height:1.9;color:#3D3328;margin-bottom:12px;"><b style="color:#7A5A8E;">🔍 更深一層：</b>'+pk.deeper+'</div>';
        h+='<div style="background:#EEF4FA;border-left:4px solid #6C93B8;border-radius:8px;padding:11px 14px;font-size:14px;line-height:1.9;color:#3D3328;margin-bottom:12px;"><b style="color:#3F6A94;">💼 放到今天的職涯與生活：</b>'+pk.modern+'</div>';
        h+='<div style="background:#EEF6EE;border-left:4px solid #5FA85F;border-radius:8px;padding:11px 14px;font-size:14px;line-height:1.9;color:#3D3328;"><b style="color:#3F7A3F;">✅ 這階段可以做：</b>'+pk.do+'</div>';
        h+='</div>';
      }
      h+='</details>';
    });
    h+='<div style="font-size:12px;color:#9A8AA8;margin-top:8px;">※ 年、月、日各自先化約成個位數，再套：第一高峰數＝生月數＋生日數、第二＝生日數＋生年數、第三＝第一＋第二、第四＝生月數＋生年數。<b>第三、四階遇到 10、11、22 不化約</b>。年齡分界：第一階 0–'+extra.e1+' 歲（36 減命運數 '+extra.destiny+'），第二階起每九年一段；年齡為粗估，實際以生日當天為準。</div></div>';
    ...
    var lim=D.limit[extra.limit];
    h+='<div class="num-card"><h3 class="num-h2">🔓 打破框架 — 限制數 '+extra.limit+'</h3>';
    if(lim){
      h+='<div style="background:#F7F3EC;border-radius:10px;padding:12px 14px;margin-bottom:10px;"><div style="font-size:12px;color:#9A8AA8;margin-bottom:4px;">你身上的那道框</div><div style="font-size:14.5px;line-height:1.9;color:#3D3328;">'+lim.frame+'</div></div>';
      h+='<div style="background:#EEF6EE;border-left:4px solid #5FA85F;border-radius:8px;padding:12px 14px;"><div style="font-size:13px;font-weight:700;color:#3F7A3F;margin-bottom:4px;">🔨 這樣打破它</div><div style="font-size:14.5px;line-height:1.9;color:#3D3328;">'+lim.breakit+'</div></div>';
    }else{
      h+='<div style="background:#F7F3EC;border-radius:10px;padding:12px 14px;font-size:14.5px;line-height:1.9;color:#3D3328;">這個組合較少見，先看你的挑戰數與空缺數，那兩項會給你更清楚的線索。</div>';
    }
    h+='<div style="font-size:12px;color:#9A8AA8;margin-top:8px;">限制數＝生月數＋生日數（不縮減）。它描述的是你從小習得的行為模式——不是天花板，是一道你已經有能力拆掉的牆。</div></div>';
