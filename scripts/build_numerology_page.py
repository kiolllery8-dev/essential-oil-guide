...
EDU_SECTION = '''
  ...
  <section style="margin:44px 0;">
    ...
    <div class="num-card"><strong style="color:#7A5A8E;">Q：生命靈數是不是算命？</strong><p style="margin:8px 0 0;font-size:14.5px;line-height:1.85;">嚴格說不算。它比較像一份「性格大數據」，用西元生日換算出 1 到 9 的能量原型，幫你看懂個性與天賦、發揮自己。算命／東方命理（八字、紫微）則擅長看時機與運勢節奏。兩者切入點不同，目的都是了解自己。想看「算命 vs 生命靈數」七大面向逐項對照 👉 <a href="/numerology-vs-fortune-telling/" style="color:#6F5E93;font-weight:600;border-bottom:1px solid #C9B6DF;text-decoration:none;">完整對照表</a>。</p></div>
