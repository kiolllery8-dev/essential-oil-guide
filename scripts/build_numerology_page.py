...
EDU_SECTION = '''
  ...
  <section style="margin:44px 0;">
    ...
    <div class="num-card"><strong style="color:#7A5A8E;">Q：算命與生命靈數有什麼不同嗎？</strong><p style="margin:8px 0 0;font-size:14.5px;line-height:1.85;">兩者切入點不同：<b>生命靈數</b>看的是性格與天賦（你是誰、強項在哪），<b>算命／東方命理</b>（八字、紫微）看的是時機與運勢節奏（什麼時候做什麼），目的都是更了解自己。想看七大面向逐項對照 👉 <a href="/numerology-vs-fortune-telling/" style="color:#6F5E93;font-weight:600;border-bottom:1px solid #C9B6DF;text-decoration:none;">算命 vs 生命靈數完整對照表</a>。</p></div>
