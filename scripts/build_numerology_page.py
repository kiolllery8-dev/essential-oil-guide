...
# 欄位：name 短名／core 一句話定調／detail 這九年會發生什麼（完整）／
...
PINNACLE_THEME = {
    1: dict(
        ...
        modern='現代對應：這是最適合開始「以自己為名」的九年——創業、獨立接案、'
               ...
               '沒有決策權的位置——那會讓這九年的能量卡住。',
        do='把「我想要什麼」明確講出來，並實際啟動一件屬於自己的事；'
           '每次跌倒後記下你是怎麼站起來的——那個紀錄就是這九年真正累積的資產。'),
    2: dict(
        name='協調與感受',
        ...
        modern='現代對應：專案協調、人資、客戶成功、UX 研究、諮商與心理輔導、'
               ...
               '在自媒體領域，這九年適合做訪談型內容、共創與聯名，而不是單打獨鬥的個人秀。'
    ...
    11: dict(
        ...
        modern='現代對應：身心靈教學與療癒工作、直覺型創作、'
               ...
               '在一般職場裡，這九年你常會是那個「先察覺到問題」的人——'
               '組織文化、團隊氣氛、產品方向出錯時，你比別人早知道。'
               '典型場景：開始教別人靜心或療癒、'
               '把靈性經驗整理成可以傳遞的內容、'
               '在高壓環境裡成為穩定人心的角色。'
               '要特別留意身心負荷：高敏感的人在這九年最容易耗竭，'
               '規律作息與界線不是選項，是必要條件。',
        do='建立每天固定的靜心或放鬆練習；'
...
(function(){
  ...
  function render(life,bday,talent,zo,innate,counts,missing,active,flow,ty,combo,stages,curStage,age,lunarNote,flowInfo,zodiac,extra){
    ...
    h+='<p style="font-size:13.5px;color:#7A6852;margin:0 0 4px;">人生分成四個階段，每一段被一個數字能量主導，一段大約九年——這九年會決定你被推去練什麼、什麼事變容易、什麼事會卡。你現在大約 '+age+' 歲，走在下方標示「你現在這裡」的那一段。</p>';
    ...
    stages.forEach(function(st,i){
      ...
      if(pk){
        ...
        h+='<div style="background:#FFF4E6;border-left:4px solid #E8A04B;border-radius:8px;padding:11px 14px;font-size:14px;line-height:1.9;color:#3D3328;margin-bottom:12px;"><b style="color:#B5701A;">⚠ 這九年要小心：</b>'+pk.watch+'</div>';
