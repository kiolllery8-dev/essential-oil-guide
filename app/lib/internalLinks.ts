...
export const INTERNAL_LINKS: InternalLink[] = [
  ...
  // ─── IFA 第二波（破解精油+驅蟲手冊+應用全書）───
  { keyword: '綠薄荷精油', href: '/oil-spearmint/', title: '綠薄荷精油完整指南', isOil: true },
  { keyword: '綠薄荷', href: '/oil-spearmint/', title: '綠薄荷精油完整指南', isOil: true },
  { keyword: 'Spearmint', href: '/oil-spearmint/', title: '綠薄荷精油完整指南', isOil: true },
  { keyword: '香芹酮', href: '/oil-spearmint/', title: '綠薄荷香芹酮成分說明' },
  { keyword: '穗花薰衣草', href: '/oil-spike-lavender/', title: '穗花薰衣草精油完整指南', isOil: true },
  { keyword: 'Spike Lavender', href: '/oil-spike-lavender/', title: '穗花薰衣草精油完整指南', isOil: true },
  { keyword: '醒目薰衣草', href: '/oil-lavandin/', title: '醒目薰衣草精油完整指南', isOil: true },
  { keyword: 'Lavandin', href: '/oil-lavandin/', title: '醒目薰衣草精油完整指南', isOil: true },
  { keyword: 'Grosso', href: '/oil-lavandin/', title: '醒目薰衣草 Grosso 品種' },
  { keyword: '西洋蓍草', href: '/oil-yarrow/', title: '西洋蓍草精油完整指南', isOil: true },
  { keyword: '蓍草精油', href: '/oil-yarrow/', title: '西洋蓍草精油完整指南', isOil: true },
  { keyword: '蓍草', href: '/oil-yarrow/', title: '西洋蓍草精油完整指南', isOil: true },
  { keyword: 'Yarrow', href: '/oil-yarrow/', title: '西洋蓍草精油完整指南', isOil: true },
  { keyword: 'Achillea', href: '/oil-yarrow/', title: '西洋蓍草精油完整指南', isOil: true },
  { keyword: '黑雲杉精油', href: '/oil-black-spruce/', title: '黑雲杉精油完整指南', isOil: true },
  { keyword: '黑雲杉', href: '/oil-black-spruce/', title: '黑雲杉精油完整指南', isOil: true },
  { keyword: 'Black Spruce', href: '/oil-black-spruce/', title: '黑雲杉精油完整指南', isOil: true },
  { keyword: '腎上腺疲勞', href: '/oil-black-spruce/', title: '黑雲杉腎上腺疲勞配方' },
  { keyword: '檸檬尤加利', href: '/oil-lemon-eucalyptus/', title: '檸檬尤加利精油完整指南', isOil: true },
  { keyword: 'Lemon Eucalyptus', href: '/oil-lemon-eucalyptus/', title: '檸檬尤加利精油完整指南', isOil: true },
  { keyword: 'OLE', href: '/oil-lemon-eucalyptus/', title: 'CDC 認證 OLE 檸檬尤加利' },
  { keyword: '天然驅蟲', href: '/article-insect-repellent/', title: '天然驅蟲完整指南' },
  { keyword: '天然驅蚊', href: '/article-insect-repellent/', title: '天然驅蚊精油完整指南' },
  { keyword: '驅蟲精油', href: '/article-insect-repellent/', title: '驅蟲精油完整指南' },
  { keyword: '防蚊配方', href: '/article-insect-repellent/', title: '防蚊精油配方' },
  { keyword: '薰衣草比較', href: '/article-lavender-comparison/', title: '三大薰衣草精油完整比較' },
  { keyword: '三大薰衣草', href: '/article-lavender-comparison/', title: '三大薰衣草精油完整比較' },
  { keyword: '頭狀薰衣草', href: '/article-lavender-comparison/', title: '頭狀薰衣草 vs 其他薰衣草' },
